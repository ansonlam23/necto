...
must_haves:
  truths:
    - "Agent filters providers by constraints (price, region, GPU type)"
    - "Ranking algorithm uses weighted scoring (price 60%, quality 40%)"
    - "Top 3 providers returned with tradeoff explanations"
    - "Full reasoning trace captures all decisions and rejections"
    - "Geographic diversity, latency, reputation factors included"
  artifacts:
