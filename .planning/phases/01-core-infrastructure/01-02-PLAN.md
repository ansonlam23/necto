...
must_haves:
  truths:
    - "TypeScript types exist for all core domain objects"
    - "Provider interface supports multiple GPU types and pricing models"
    - "Job interface includes Tracked/Untracked mode flag"
    - "Pricing types handle USD normalization and token conversions"
    - "Constants define GPU performance ratios and supported providers"
  artifacts:
