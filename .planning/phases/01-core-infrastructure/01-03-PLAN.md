...
must_haves:
  truths:
    - "AGENT-01: Provider adapter interface abstracts all provider-specific APIs"
    - "AGENT-01: 6-8 providers available including Akash, Lambda, Filecoin, io.net, and Synapse-listed"
    - "AGENT-01: Mock providers provide realistic hardcoded data for demo"
    - "AGENT-01: Provider registry can list all providers and filter by capabilities"
    - "AGENT-01: Each provider returns quotes in common format via getQuotes()"
  artifacts:
...
<task type="auto">
  ...
  <action>
    ...
    Total providers: Akash + Lambda + Filecoin + io.net + 4 mocks = 8 providers ✓
